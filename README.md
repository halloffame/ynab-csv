...
If you have any other issues or suggestions, go to https://github.com/halloffame/ynab-csv/issues and create an issue if one doesn't already exist. Also feel free to contribute code by making a pull request.